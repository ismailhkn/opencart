...
class ControllerExtensionReportCustomerActivity extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/report/customer_activity', 'token=' . $this->session->data['token'] . $url, true),
		...
		$pagination->url = $this->url->link('extension/report/customer_activity', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('extension/report/customer_activity', $data));
	}
}
